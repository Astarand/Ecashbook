...
Route::middleware(['ensure.login'])->group(function () {
	...
	Route::get('/get-cashflow-summary', [DashboardController::class, 'getCashflowSummary'])->name('get.cashflow.summary');
	...
	Route::get('/generate-hr-letter', [HRLetter::class, 'GenerateLetter'])->name('user.GenerateHRLetter');
	Route::post('/hr-letter/store', [HRLetter::class, 'store'])->name('hr_letter.store');
	...
	Route::get('/profit-loss-report', [ReportsController::class, 'ProfitLoss'])->name('user.ProfitLossReport');
	Route::get('/balance-sheet-report', [ReportsController::class, 'BalanceSheet'])->name('user.BalanceSheetReport');
	...
	Route::post('/fetch-profit-loss-data', [ReportsController::class, 'profit_loss_data'])->name('profit_loss_data');
	Route::post('/fatch-trial-balance-data', [ReportsController::class, 'fatch_trial_balance_data'])->name('trial_balance_data');
	Route::post('/fatch-balance-sheet-data', [ReportsController::class, 'fatch_balance_sheet_data'])->name('balance_sheet_data');
	Route::get('/previousbalance-sheet/previousbalance', [ReportsController::class, 'previousbalance'])->name('previousbalancebalance-sheet.create');
	Route::post('/balance-sheet/savebalancesheetprivious', [ReportsController::class, 'savebalancesheetprivious'])->name('balance-sheet.savebalancesheetprivious');
...
Route::middleware(['ensure.login'])->group(function () {
	...
	Route::post('/download-balance-sheet-pdf', [ReportsController::class, 'downloadBalanceSheetPdf'])->name('balancesheet.download.pdf');
	Route::post('/download-pl-sheet-pdf', [ReportsController::class, 'downloadPLSheetPdf'])->name('plsheet.download.pdf');
