...
// =========================================================================
// E-CASHBOOK ROUTING COMPONENT
// Organized and formatted for premium readability, structure, and speed.
// =========================================================================

/* Core / Framework Namespaces */
...
/* User / Company Owner Controllers */
...
// =========================================================================
// PROTECTED ROUTES (Requires ensure.login middleware)
// =========================================================================

Route::middleware(['ensure.login'])->group(function () {

	// -------------------------------------------------------------------------
	// DASHBOARD & CORE COMMON MODULES
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// ORGANIZATION PROFILE & DIRECTORS
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// ACCOUNTING: PRODUCTS, SERVICES & PROJECTS
	// -------------------------------------------------------------------------
	Route::delete('/product-image/{id}', [ProductServiceController::class,'deleteImage']);

	// -------------------------------------------------------------------------
	// ACCOUNTING: SALES, QUOTATIONS & PROFORMAS
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// ACCOUNTING: PURCHASE, PROCUREMENT & PO
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// ACCOUNTING: INCOME, EXPENSES & CUSTOM INVOICES
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// ACCOUNTING: CASH, BANKING & CONTRA
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// ACCOUNTING: FINANCIAL LEDGER & REPORTS
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// STATUTORY COMPLIANCE, GST & TAXES
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// CA / ACCOUNTANT DASHBOARD & OPERATIONS
	// -------------------------------------------------------------------------
	...
	// Route::post('/calculate-tds', [PayrollManagement::class, 'calculateTDSAjax'])->name('calculate_tds'); // Overridden by AssetController@calculateTdsAjax (calculate.tds)

	// -------------------------------------------------------------------------
	// SYSTEM ADMINISTRATION & SUPERADMIN SETTINGS
	// -------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// MISCELLANEOUS / UNCATEGORIZED ROUTES
	// -------------------------------------------------------------------------
