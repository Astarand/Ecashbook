    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="page-header-title">
                            <h2 class="mb-0">Supply Requisitions</h2>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="addRequisitionModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <form class="modal-content border-0 shadow-lg" id="addRequisitionForm" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- Enhanced Header -->
                    <div class="modal-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="modal-title mb-0 fw-bold">New Supply Requisition</h5>
                                <small class="opacity-75">Submit your supply request</small>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            form.addEventListener("submit", function(e) {
                ...
                fetch("{{ route('UserEmployeeRequisition.store') }}", {
                    method: "POST",
                    headers: {
            ...
            document.querySelectorAll('.edit-requisition-form').forEach(function(form){
                form.addEventListener('submit', function(e){
                    ...
                    fetch("{{ url('/UserEmployee-supply-requisitions/update') }}/" + reqId, {
                        method: "POST",
                        headers: {
                            'X-CSRF-TOKEN': "{{ csrf_token() }}"
                        },
                ...
                steps: [
                    {
                        ...
                        intro: '<div class="text-center"><div class="welcome-tour-icon-container mb-4 d-inline-flex align-items-center justify-content-center" style="width: 90px; height: 90px; background: linear-gradient(135deg, rgba(0, 140, 173, 0.15), rgba(99, 102, 241, 0.15)); border-radius: 50%; color: #008CAD;"><i class="ti ti-shopping-cart" style="font-size: 45px;"></i></div><p class="mb-0 text-secondary" style="font-size: 1.05rem;">Request new assets, stationery, technological gadgets, or other office supplies here.</p></div>'
                    },
                    {
