        ...
        <div class="page-block">
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <a href="javascript:void(0);" id="start-purchase-order-list-tour" class="text-primary d-flex align-items-center gap-1 fw-semibold" style="font-size: 0.95rem;">
...
<script>
    ...
    $(document).ready(function() {
        $('#start-purchase-order-list-tour').on('click', function(e) {
            e.preventDefault();
            startPurchaseOrderTour();
        });
    });
</script>
@endsection
