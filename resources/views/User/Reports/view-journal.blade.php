			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						...
						@if(($journal->entry_type ?? '') == 'Third Party Settlement')
							...
							<div class="col-sm-6 mb-3">
								<label class="form-label">Against Ledger</label>
								<input type="text" class="form-control" value="{{ $journal->against_ledger }}" readonly>
							</div>

							<div class="col-sm-12 mb-3">
								<label class="form-label">Narration</label>
								<textarea class="form-control" rows="3" readonly>{{ $journal->narration }}</textarea>
							</div>
