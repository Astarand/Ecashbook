            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <!-- Settlement Type -->
                        <div class="col-sm-6 mb-3" id="settlementTypeDiv" style="display:none;">
                            ...
                            <select class="form-select" name="settlement_type" id="settlement_type">
                                ...
                                <option value="Payable Adjustment">Payable Adjustment</option>
                                <option value="Receivable Adjustment">Receivable Adjustment</option>
                            </select>
                        </div>

                        <div class="col-sm-6 mb-3" id="againstLedgerDiv" style="display:none;">
                            <label class="form-label">Against Ledger <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="against_ledger" id="against_ledger" placeholder="Enter Against Ledger">
                        </div>

                        <!-- Narration -->
                        <div class="col-sm-12 mb-3" id="narrationDiv" style="display:none;">
...
<script>
    ...
    // Settlement Type and Narration visibility
    $(document).ready(function () {
        ...
        function toggleSettlementFields() {
            ...
            if (entryType === 'Third Party Settlement') {

                // Show Settlement Type dropdown
