        ...
        <div class="page-block">
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <a href="javascript:void(0);" id="start-add-inventory-expenses-tour" class="text-primary d-flex align-items-center gap-1 fw-semibold" style="font-size: 0.95rem;">
...
<script>
    ...
    function startAddInventoryExpensesTour() {
        if (typeof introJs !== 'function') return;

        introJs().setOptions({
            steps: [
                {
                    title: 'Add Inventory Expenses Guide',
                    intro: '<div class="text-center"><div class="welcome-tour-icon-container mb-4 d-inline-flex align-items-center justify-content-center" style="width: 90px; height: 90px; background: linear-gradient(135deg, rgba(66, 47, 144, 0.15), rgba(99, 102, 241, 0.15)); border-radius: 50%; color: #422f90;"><i class="ti ti-info-circle" style="font-size: 45px;"></i></div><p class="mb-0 text-secondary" style="font-size: 1.05rem;">Record inventory costs, quantities, and item purchases.</p></div>'
                },
                {
                    title: 'Add Inventory Expenses',
                    intro: 'Record inventory costs, quantities, and item purchases.'
                }
            ],
            showBullets: true,
            showProgress: true,
    ...
    $(document).ready(function() {
        $('#start-add-inventory-expenses-tour').on('click', function(e) {
            e.preventDefault();
            startAddInventoryExpensesTour();
        });
    });
</script>
@endsection