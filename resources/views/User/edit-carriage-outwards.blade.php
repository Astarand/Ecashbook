...
@section('container')
    ...
    <div class="pc-content">
        <div class="row align-item-center mb-4">
            <h2 class="text-muted">Edit Carriage Outward</h2>
        </div>
        <div class="card">
            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="row mb-3">
                                            ...
                                            <div class="mb-3 col-md-3">
                                                ...
                                                <input type="text" name="cust_order_no" id="cust_order_no" value="{{$carriageout->cust_order_no}}"  class="form-control" placeholder="Enter Order Number">
                                            </div>
                                            <div class="mb-3 col-md-3">
                                                <label class="form-label" for="inputEmail4">Dispatch Document Number<span class="text-danger">*</span></label>
                                                <input type="text" name="cust_dispatch_no" id="cust_dispatch_no" value="{{$carriageout->cust_dispatch_no}}" class="form-control" placeholder="Enter Dispatch Document Number">
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <select class="form-select" name="disp_through" id="disp_through">
                                                            ...
                                                            <option value="Parcel & Courier Service" <?php echo ('Parcel & Courier Service'==$carriageout->disp_through)? "selected":""?>> Parcel & Courier Service</option>
                                ...
                                <form action="javascript:void(0);" method="POST" name="add_other_detail" id="add_other_detail">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="file" id="other_uplode_doc" name="other_uplode_doc" class="form-control" aria-label="file example" >
                                        </div>
                                    </div>
                                    <div class="d-flex wizard justify-content-between mt-3">
                                        <div class="first">
