            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Quotation  List</li>
                    </ul>
                    <a href="javascript:void(0);" id="start-sales-quotation-list-tour" class="text-primary d-flex align-items-center gap-1 fw-semibold" style="font-size: 0.95rem;">
                ...
                <div class="col-md-4">
                    <div class="page-header-title">
                        <h2 class="mb-0">Quotation List</h2>
                    </div>
                </div>
                <div class="col-md-8 text-end">
                    <a href="{{ route('user.CreateSalesQuotation') }}" class="btn btn-primary"><i class="ti ti-square-plus"></i> Add New Quotation</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table tbl-product my-3">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><span class="text-muted text-hover-primary">Click/QTN/25/0001</span></td>
                                <td><span class="text-muted">10-02-2025</span></td>
                                <td><span class="text-muted">500 Box</span></td>
                                <td><span class="text-muted">₹ 12,500</span></td>
                                <td>
                                    <span><i class="ti ti-dots-vertical f-20"></i></span>
                                    <div class="prod-action-links">
                                        <ul class="list-inline me-auto mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip" title="View Quotation">
                            ...
                            <tr>
                                ...
                                <td><span class="text-muted">60 Pouch</span></td>
...
<script>
    ...
    $(document).ready(function() {
        $('#start-sales-quotation-list-tour').on('click', function(e) {
            e.preventDefault();
