            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Income Tax Filing Reports</li>
                    </ul>
                    <a href="javascript:void(0);" id="start-income-tax-return-filing-list-tour" class="text-primary d-flex align-items-center gap-1 fw-semibold" style="font-size: 0.95rem;">
                ...
                <div class="col-md-4">
                    <div class="page-header-title">
                        <h2 class="mb-0">Income Tax Filing Reports</h2>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        ...
        <div class="modal-content">
			<form id="chatForm" enctype="multipart/form-data">
				<div class="modal-header">
					<h5 class="modal-title" id="ticketChatModalLabel">ITR Filing Conversation</h5>
						...
						<div class="chat-content">
							<div class="d-flex align-items-center px-3 py-3 border-bottom">
								...
								<div class="flex-grow-1 ms-3">
									<h6 class="mb-0">ITR Filing Desk</h6>
...
<script>
	...
	function openChat(ticketId, status) 
	{
		...
		fetch(`/itrfiling-reply/${ticketId}/messages`, {
	...
	document.getElementById('chatForm').addEventListener('submit', function (e) {
		...
		fetch(`/itrfiling-reply/send-message`, {
			method: 'POST',
			headers: {
	...
	function startChatAutoRefresh() 
	{
		...
		chatInterval = setInterval(() => {
			if (currentTicket && ticketStatus !== 'closed') {
				fetch(`/itrfiling-reply/${currentTicket}/messages`, {
					headers: { 'Accept': 'application/json' }
				})
				.then(res => res.json())
				.then(data => {
