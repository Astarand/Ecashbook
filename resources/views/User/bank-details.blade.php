                        ...
                        <div class="card-body">
                            <div class="row">
								...
								<div class="col-6">
                                    <div class="d-flex align-items-center">
                                        <div class="avtar avtar-s bg-light-danger flex-shrink-0">
                                            <i class="ph-duotone ph-wallet f-20"></i>
                                        </div>
                                        <div class="flex-grow-1 ms-2">
                                            <p class="mb-0 text-muted">Closing Balance</p>
                                            <h6 class="mb-0">₹ {{ $closingBalance }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            steps: [
                {
                    ...
                    intro: '<div class="text-center"><div class="welcome-tour-icon-container mb-4 d-inline-flex align-items-center justify-content-center" style="width: 90px; height: 90px; background: linear-gradient(135deg, rgba(0, 140, 173, 0.15), rgba(99, 102, 241, 0.15)); border-radius: 50%; color: #008CAD;"><i class="ti ti-building-bank" style="font-size: 45px;"></i></div><p class="mb-0 text-secondary" style="font-size: 1.05rem;">Review your bank account particulars, monitor credits/debits, log manual transactions, or upload statements.</p></div>'
                },
                {
