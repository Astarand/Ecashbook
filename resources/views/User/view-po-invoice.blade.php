                                                ...
                                                @foreach ($sales_values as $value)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="javascript:void(0);" data-id="{{ $value->id }}" data-sid="{{ $value->sid }}" data-rate="{{ $value->rate }}" data-discamt="{{ $value->disc_amt }}" data-taxtype="{{ $value->tax_type }}"  class="avtar avtar-s btn-link-primary btn-pc-default" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit"><i class="ti ti-pencil f-20"></i></a>
                                                            <span data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete">
                                                                <a href="javascript:void(0);" data-id="{{ $value->id }}" data-sid="{{ $value->sid }}"  class="avtar avtar-s btn-link-danger btn-pc-default" data-bs-toggle="modal" data-bs-target="##delete_discount"><i class="ti ti-trash f-20"></i></a>
                                                            </span>
                                    ...
                                    <div class="col-12">
                                        <div class="invoice-total ms-auto">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <p class="f-w-600 mb-1 text-end">₹<?php echo $totalTax; ?></p>
                                                </div>
                                                <div class="col-6">
                                                    <p class="text-muted mb-1 text-start">IGST :</p>
                                                </div>
                                                <div class="col-6">
                                                    <p class="f-w-600 mb-1 text-end">₹0.000</p>
                                                </div>
                                                <div class="col-6">
                                    ...
                                    <div class="row" id="partial" style="display: none;">
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" name="total_amount" id="total_amount" value="{{ $sales->total_amount }}" class="form-control" placeholder="Total Amount">
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group ">
                                                <label>Advance Amount<span class="text-danger">*</span></label>
                                                <input type="text" name="advance_amount" id="advance_amount" value="{{ $sales->advance_amount }}" class="form-control" placeholder="Advance Amount">
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group ">
                                                <label>Due Amount<span class="text-danger">*</span></label>
                                                <input type="text" name="due_amount" id="due_amount" value="{{ $sales->due_amount }}" class="form-control" placeholder="Due Amount">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
