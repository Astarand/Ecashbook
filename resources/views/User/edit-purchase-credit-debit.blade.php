...
<!-- [ breadcrumb ] start -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Edit Purchase Debit</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row align-item-center mb-4">
        <h2 class="text-muted">Edit Purchase Debit</h2>
    </div>
    <div class="card">
        <div class="card-body">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select class="form-control" name="v_name" id="invNameCustomer" onchange="changeCustomer_purchase();">
														...
														@foreach($vendorData as $k=>$vendor)
															<option value="{{ $vendor->id }}"<?php echo @($vendor->id==$sales->v_name)? "selected":"" ?> >{{ $vendor->vendor_name }}</option>
														@endforeach
                                                    </select>
                                            </div>
                                            <div class="mb-3 col-md-4">
