        ...
        <div class="page-block">
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <a href="javascript:void(0);" id="start-holiday-list-tour" class="text-primary d-flex align-items-center gap-1 fw-semibold" style="font-size: 0.95rem;">
...
function deleteHoliday(id) {
    ...
    function startHolidayListTour() {
        if (typeof introJs !== 'function') return;

        introJs().setOptions({
            steps: [
                {
                    title: 'Holiday Calendar Guide',
    ...
    $(document).ready(function() {
        $('#start-holiday-list-tour').on('click', function(e) {
            e.preventDefault();
            startHolidayListTour();
        });
    });
</script>
@endsection
