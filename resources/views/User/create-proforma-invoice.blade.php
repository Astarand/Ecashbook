        ...
        <div class="page-block">
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <a href="javascript:void(0);" id="start-create-proforma-invoice-tour" class="text-primary d-flex align-items-center gap-1 fw-semibold" style="font-size: 0.95rem;">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="mb-3 col-md-4">
                        <label class="form-label" for="inv_num">Proforma Invoice Number <span class="text-danger">*</span></label>
                        <input type="text" name="inv_num" id="inv_num" class="form-control" value="Click/PI/25/0001" readonly>
                    </div>
                    <div class="mb-3 col-md-4">
                        ...
                        <select name="quotation_ref_num" id="quotation_ref_num" class="form-control">
                            ...
                            <option value="QTN-001">QTN-001</option>
                            <option value="QTN-002">QTN-002</option>
                            <option value="QTN-003">QTN-003</option>
                        </select>
                    </div>
                    <div class="mb-3 col-md-4">
                            ...
                            <form action="javascript:void(0);" method="post">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="bank_id" id="bank_id" class="form-select has-success" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" placeholder="Other Dispatch Details">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
...
<script>
    ...
    $(document).ready(function() {
        $('#start-create-proforma-invoice-tour').on('click', function(e) {
            e.preventDefault();
            startCreateProformaInvoiceTour();
        });
    });
</script>
