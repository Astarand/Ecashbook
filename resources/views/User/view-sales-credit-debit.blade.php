...
<!-- [ breadcrumb ] start -->
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">View Credit Note</li>
                    </ul>
                </div>
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">View Credit Note</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row align-item-center mb-4">
        <h2 class="text-muted">View Credit</h2>
    </div>
    <div class="card">
        <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <form action="javascript:void(0);" method="POST" name="add_other_detail" id="add_other_detail">
                                ...
                                <div class="d-flex wizard justify-content-between mt-3">
                                        ...
                                        <div class="last">
                                        <a href="{{url('/sale-credit-debit')}}" class="btn btn-danger">
                                            Cancel
                                        </a>
                                        </div>
                                    </div>
