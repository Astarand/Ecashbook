        ...
        <div class="col-sm-12">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    <div class="row g-3">
                        <!-- Top Header: Logo and Quotation Details -->
                        <div class="col-12 pb-3 border-bottom">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-sm-6 text-sm-end">
                                    <h4 class="mb-1 fw-bold text-dark">QUOTATION</h4>
                                    <h5 class="mb-1 text-muted">Quotation ID: <span class="text-primary fw-bold">#{{ $inv_num }}</span></h5>
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        @php
                                            ...
                                            $totalGovPay = 0;
                                            $totalSerPay = 0;
                                            $items = !empty($sales_values) ? $sales_values : (!empty($quotations_values) ? $quotations_values : []);
                                        @endphp
                                        @if(!empty($items))
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="border rounded-3 p-3 h-100 bg-light-subtle">
                                ...
                                <div class="mb-0 text-muted" style="font-size: 0.88rem; line-height: 1.5;">
                                    ...
                                    @else
                                        1. Quotation is valid for 30 days from date of issue.<br>
                        ...
                        <div class="col-12 text-end d-print-none mt-4">
                            <a href="{{ url('/sales-quotation') }}" class="btn btn-outline-secondary me-2">
                                <i class="ti ti-arrow-left me-1"></i> Back
                            </a>
                            <a href="{{ url('/quotation-invoice-pdf/'.base64_encode($sales->id).'/pdf') }}" target="_blank" class="btn btn-primary">
