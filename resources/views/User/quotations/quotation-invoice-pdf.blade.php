...
<body>
    <!-- Top Header with Dynamic Logo and Quotation Details -->
    <table class="header-table">
        <tr>
            ...
            <td style="width: 45%; text-align: right; vertical-align: middle;">
                ...
                <div class="invoice-meta"><strong>Quotation No:</strong> <span style="font-weight: bold; color: #000000;">#{{ $inv_num }}</span></div>
        ...
        <tr>
            ...
            <td class="info-box" style="width: 48%; vertical-align: top;">
                ...
                <div class="party-desc" style="line-height: 1.45; font-size: 8.5px; color: #334155;">
                    ...
                    @else
                        1. Quotation is valid for 30 days from the date of issue.<br>
