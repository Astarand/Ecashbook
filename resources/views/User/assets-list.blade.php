								...
								<div class="prod-action-links">
									<ul class="list-inline me-auto mb-0">
										...
										@if($req_tag != 1)
											...
											@if ($asset->pay_status != 'Full' && $asset->assetType == 'non-current')
            ...
            steps: [
                {
                    ...
                    intro: '<div class="text-center"><div class="welcome-tour-icon-container mb-4 d-inline-flex align-items-center justify-content-center" style="width: 90px; height: 90px; background: linear-gradient(135deg, rgba(0, 140, 173, 0.15), rgba(99, 102, 241, 0.15)); border-radius: 50%; color: #008CAD;"><i class="ti ti-briefcase" style="font-size: 45px;"></i></div><p class="mb-0 text-secondary" style="font-size: 1.05rem;">Review company assets database, monitor depreciation details, and track current vs. non-current holdings.</p></div>'
                },
                {
