                ...
                <div class="row">
                    <div class="col-lg-5 col-xxl-3">
                        <div class="card overflow-hidden">
                            ...
                            <div class="nav flex-column nav-pills list-group list-group-flush account-pills mb-0"
                                ...
                                <a class="nav-link list-group-item list-group-item-action" id="ca-access-tab"
                                    data-bs-toggle="pill" href="#ca-access" role="tab" aria-controls="ca-access"
                                    aria-selected="false">
                                    <span class="f-w-500"><i class="ph-duotone ph-key m-r-10"></i>CA / Accountant Access</span>
                                </a>
                    ...
                    <div class="col-lg-7 col-xxl-9">
                        <div class="tab-content" id="company-profile-set-tabContent">
                                                        ...
                                                        <div class="chat-avtar d-inline-flex mx-auto">
                                                            ...
                                                            @if (isset($ca_detail->comp_logo) && $ca_detail->comp_logo != '')
                                                                <img class="rounded-circle img-fluid wid-90 img-thumbnail"
                                                                    src="{{ asset('/public/uploads/profile/' . $ca_detail->comp_logo) }}"
                                                                    alt="User image">
                                                            @else
                                                                <img class="rounded-circle img-fluid wid-90 img-thumbnail"
                            ...
                            <div class="tab-pane fade" id="ca-access" role="tabpanel" aria-labelledby="ca-access-tab">
                                <div class="card">
                                    <div class="card-header">
									...
									@php
										...
										function hasAccountPermission($permissions, $module, $type)
										{
											return isset($permissions[$module][$type]) &&
												   $permissions[$module][$type] == true;
										}
									@endphp
                                    <div class="card-body">									
										<div class="row">
											@foreach($accountant_access as $key => $access)
												...
												@php
													...
													$viewChecked = hasAccountPermission(
														$caPermissions,
														$moduleValue,
														'view'
													);

													$editChecked = hasAccountPermission(
														$caPermissions,
														$moduleValue,
														'edit'
													);
												...
												<div class="col-md-6 mb-3">
													<div class="p-3 border rounded-3 bg-light-subtle">
														<div class="d-flex align-items-center justify-content-between">
															<div>
																...
																<small class="text-muted">
																	Manage access for {{ $access->module_name }}
																</small>
															</div>

															<div class="form-check form-switch p-0">
																<input class="m-0 form-check-input h5 position-relative ca-access-toggle"
																	   type="checkbox"
																	   role="switch"
																	   data-target="access-{{ $key }}"
														...
														<div class="ca-access-options mt-3 pt-3 border-top"
															 id="access-{{ $key }}"
															 style="{{ $mainChecked ? '' : 'display:none;' }}">
															<div class="d-flex gap-4">
																<div class="form-check form-switch d-flex align-items-center gap-2">
																	<input class="form-check-input permission-checkbox m-0"
																		   type="checkbox"
																		   role="switch"
											...
											<button type="button" id="savePermissionBtn" class="btn btn-primary">
												Save Permissions
											</button>
										</div>									
                                    </div>
			...
			function launch() {
				let tour = introJs().setOptions({
					steps: [
						...
						{
							element: '#ca-access-tab',
							title: 'CA / Accountant Access',
							intro: 'Define module-wise access levels (View or Edit permissions for Sales, Purchases, Banking, HR/Payroll) for your Chartered Accountant.',
							tabId: 'ca-access-tab'
						},
						{
