            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Edit Liabilities & Borrowings</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row" id="currentLiabilities" style="display:none;">
                        <div class="col-xl-4 mb-3">
                            ...
                            <select class="form-select" id="CurrentLiabilitiesType" name="CurrentLiabilitiesType">
                                ...
                                <option value="ptax_payable" {{ ($subDetails->CurrentLiabilitiesType ?? '') == 'ptax_payable' ? 'selected' : '' }}>PTAX Payable</option>
                        ...
                        <div id="clSection_trade_payables" style="display:none;" class="col-xl-12">
                            <div class="row align-items-end">
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label">Amount <span class="text-danger">*</span></label>
                                    <input type="number" readonly value="{{ $subDetails->amount ?? '' }}" name="cl_amount_trade_payables" id="cl_amount_trade_payables" class="form-control" placeholder="Enter Amount">
                                </div>
                                <div class="col-xl-4 mb-3">
                        ...
                        <div id="clSection_advance_from_customer" style="display:none;" class="col-xl-12">
                            <div class="row align-items-end">
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label">Amount <span class="text-danger">*</span></label>
                                    <input type="number" readonly value="{{ $subDetails->amount ?? '' }}" name="cl_amount_advance_from_customer" id="cl_amount_advance_from_customer" class="form-control" placeholder="Enter Amount">
                                </div>
                                <div class="col-xl-4 mb-3">
                        ...
                        <div id="clSection_outstanding_expenses" style="display:none;" class="col-xl-12">
                            <div class="row align-items-end">
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label">Amount <span class="text-danger">*</span></label>
                                    <input type="number" readonly value="{{ $subDetails->amount ?? '' }}" name="cl_amount_outstanding_expenses" id="cl_amount_outstanding_expenses" class="form-control" placeholder="Enter Amount">
                                </div>
                                <div class="col-xl-4 mb-3">
                        ...
                        <div id="clSection_salary_payable" style="display:none;" class="col-xl-12">
                            <div class="row align-items-end">
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label">Amount <span class="text-danger">*</span></label>
                                    <input type="number" readonly value="{{ $subDetails->amount ?? '' }}" name="cl_amount_salary_payable" id="cl_amount_salary_payable" class="form-control" placeholder="Enter Amount">
                                </div>
                                <div class="col-xl-4 mb-3">
                                    <a href="{{ url('/expenses-list') }}" target="_blank" class="btn btn-outline-primary w-100">
                                        <i class="ti ti-external-link me-1"></i> View Expenses
                        ...
                        <div id="clSection_gst_payable" style="display:none;" class="col-xl-12">
                            <div class="row align-items-end">
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label">Amount <span class="text-danger">*</span></label>
                                    <input type="number" readonly value="{{ $subDetails->amount ?? '' }}" name="cl_amount_gst_payable" id="cl_amount_gst_payable" class="form-control" placeholder="Enter Amount">
                                </div>
                                <div class="col-xl-4 mb-3">
                        ...
                        <div id="clSection_tds_payable" style="display:none;" class="col-xl-12">
                            <div class="row align-items-end">
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label">Amount <span class="text-danger">*</span></label>
                                    <input type="number" readonly value="{{ $subDetails->amount ?? '' }}" name="cl_amount_tds_payable" id="cl_amount_tds_payable" class="form-control" placeholder="Enter Amount">
                                </div>
                                <div class="col-xl-4 mb-3">
                        ...
                        <div id="clSection_pf_payable" style="display:none;" class="col-xl-12">
                            <div class="row align-items-end">
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label">Amount <span class="text-danger">*</span></label>
                                    <input type="number" readonly value="{{ $subDetails->amount ?? '' }}" name="cl_amount_pf_payable" id="cl_amount_pf_payable" class="form-control" placeholder="Enter Amount">
                                </div>
                                <div class="col-xl-4 mb-3">
                        ...
                        <div id="clSection_esi_payable" style="display:none;" class="col-xl-12">
                            <div class="row align-items-end">
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label">Amount <span class="text-danger">*</span></label>
                                    <input type="number" readonly value="{{ $subDetails->amount ?? '' }}" name="cl_amount_esi_payable" id="cl_amount_esi_payable" class="form-control" placeholder="Enter Amount">
                                </div>
                                <div class="col-xl-4 mb-3">
						...
						{{-- PTAX Payable --}}
                        <div id="clSection_ptax_payable" style="display:none;" class="col-xl-12">
                            <div class="row align-items-end">
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label">Amount <span class="text-danger">*</span></label>
                                    <input type="number" readonly value="{{ $subDetails->amount ?? '' }}" name="cl_amount_ptax_payable" id="cl_amount_ptax_payable" class="form-control" placeholder="Enter Amount">
                                </div>
                                <div class="col-xl-4 mb-3">
						...
						<div id="clSection_lwf_payable" style="display:none;" class="col-xl-12">
							<div class="row align-items-end">
								<div class="col-xl-4 mb-3">
									<label class="form-label">Amount <span class="text-danger">*</span></label>
									<input type="number" readonly value="{{ $subDetails->amount ?? '' }}" name="cl_amount_lwf_payable" id="cl_amount_lwf_payable" class="form-control" placeholder="Enter Amount">
								</div>
								<div class="col-xl-4 mb-3">
									<a href="{{ url('/payroll-reports') }}" target="_blank" class="btn btn-outline-primary w-100">
										<i class="ti ti-external-link me-1"></i> View Payroll Reports
...
<script>
    ...
    // ===== Short-term Loans & Interest Payable: show/hide logic =====
        ...
        var simpleClTypes = [
            ...
            'salary_payable', 'gst_payable', 'tds_payable', 'pf_payable', 'esi_payable', 'ptax_payable', 'lwf_payable'
        ];
                ...
                success: function (response) {
                    ...
                    if (response.status) {
                        ...
                        if (type == 'ptax_payable') {
                            $('#cl_amount_ptax_payable').val(response.amount);
                        }
            ...
            steps: [
                {
                    ...
                    intro: '<div class="text-center"><div class="welcome-tour-icon-container mb-4 d-inline-flex align-items-center justify-content-center" style="width: 90px; height: 90px; background: linear-gradient(135deg, rgba(0, 140, 173, 0.15), rgba(99, 102, 241, 0.15)); border-radius: 50%; color: #008CAD;"><i class="ti ti-edit-circle" style="font-size: 45px;"></i></div><p class="mb-0 text-secondary" style="font-size: 1.05rem;">Modify and update details for this liability record. Fields are dynamically presented based on the liability type.</p></div>'
                },
                {
