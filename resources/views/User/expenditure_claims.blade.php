...
<div class="pc-content">
    ...
    <div class="modal fade" id="addExpenditureModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <form class="modal-content shadow-lg border-0" method="POST" action="{{ route('expenditure.store') }}" enctype="multipart/form-data">
                @csrf
                <!-- Enhanced Header -->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6 mb-3">
                                            ...
                                            <p class="mb-0 fs-6">{{ $claim->employee_name ?? 'N/A' }}</p>
                                        </div>
                                        <div class="col-sm-6 mb-3">
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card border">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <select name="employee_id" class="form-select" id="edit_employee_{{ $claim->id }}" required>
                                                    <option value="">Choose Employee</option>
                                                    @foreach($employees as $emp)
                                                    <option value="{{ $emp->employee_id }}" {{ $claim->employee_id == $emp->employee_id ? 'selected' : '' }}>
                                                        {{ $emp->employee_name }} ({{ $emp->employee_id }})
                                                    </option>
                                                    @endforeach
                                                </select>
                                                <label for="edit_employee_{{ $claim->id }}">Employee</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                        ...
                        <div class="col-12">
                            <div class="card border">
                                <div class="card-header bg-transparent border-bottom">
                                    <h6 class="mb-0 text-success fw-bold">
                                        <i class="ti ti-category me-2"></i> Status
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <div class="form-floating">
                                                <select name="status" class="form-select" id="edit_status_{{ $claim->id }}">
                                                ...
                                                <label for="edit_status_{{ $claim->id }}">Status</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.querySelectorAll('.edit-claim-form').forEach(function(form){
            form.addEventListener('submit', function(e){
                ...
                fetch("{{ url('/expenditure-claims/update') }}/" + claimId, {
                    method: "POST",
                    headers: {
