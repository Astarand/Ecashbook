...
<div class="d-flex justify-content-between align-items-center w-100">
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Edit Asset Voucher</li>
                    </ul>
                    <a href="javascript:void(0);" id="start-edit-asset-voucher-tour" class="text-primary d-flex align-items-center gap-1 fw-semibold" style="font-size: 0.95rem;">
                        <u>How does this Page works?</u>
                    </a>
                </div>
    <div class="row mb-4">
        <h3>Edit Asset Voutcher</h3>
    </div>
    <div class="card">
            ...
            <form action="javascript:void(0);" method="post" name="addAssetVoucherFrm" id="addAssetVoucherFrm" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="text-end btn-page mt-4">
                        ...
                        <a href="{{ url('/assets-voutcher-list') }}" class="btn btn-outline-secondary">Cancel</a>
...
<div class="modal fade" id="add_series" tabindex="-1" aria-hidden="true" role="dialog">
    ...
    <script>
        $("form#addAssetVoucherFrm").bind("submit", function (e) {
            e.preventDefault();
    ...
    $(document).ready(function() {
        $('#start-edit-asset-voucher-tour').on('click', function(e) {
            e.preventDefault();
            startEditAssetVoucherTour();
        });
    });
</script>
@endsection