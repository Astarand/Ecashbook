                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="quantity" id="quantity_{{ $value->id }}" data-id="{{ $value->id }}" 
                                ...
                                onChange="changeQuantity(this)" class="form-control quantity" value="{{ $value->quantity }}" 
                                onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                        </td>
                        <td>
                            <input type="text" name="rate" id="rate_{{ $value->id }}" data-id="{{ $value->id }}" 
                                data-sid="{{ $value->sid }}" onChange="changeRate(this)" class="form-control rate" 
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            onclick="editItem(this)" class="avtar avtar-s btn-link-primary btn-pc-default" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit"><span><i class="ti ti-pencil f-20"></i></span></a>-->
                            <a href="javascript:void(0);" data-id="{{ $value->id }}" data-sid="{{ $value->sid }}" 
                            onclick="delItem(this)" class="avtar avtar-s btn-link-danger btn-pc-default" data-bs-toggle="modal" 
                            data-bs-target="#delete_item"><span><i class="ti ti-trash f-20"></i></span></a>
                        </td>
                    </tr>
                    <?php 
