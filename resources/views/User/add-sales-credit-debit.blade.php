            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Add Credit/Debit Note</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav nav-pills nav-justified">
                        ...
                        <li class="nav-item">
                            <a href="#others" id="tab-C" data-bs-toggle="tab" data-toggle="tab" class="nav-link icon-btn">
                                ...
                                <span class="d-none d-sm-inline">Noted Details</span>
                            </a>
                        </li>
                        <!-- end nav item -->
                    </ul>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input type="text" id="seller_pin" name="seller_pin" class="form-control" placeholder="Enter Pin Code">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form action="javascript:void(0);" method="POST" name="add_other_detail" id="add_other_detail" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" name="prodservname" id="prodservname" class="form-control" placeholder="Product / Service Name">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">HSN/SAC Code</label>
                                        <input type="text" name="hsn_sac_code" id="hsn_sac_code" class="form-control" placeholder="HSN/SAC Code">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <textarea name="term_condition" id="term_condition" class="summernote form-control" placeholder="Terms &amp; Condition" rows="1"></textarea>
                                    </div>
                                    <div class="col-md-6 mb-3">
