...
<div class="pc-content">
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/carriage-outward') }}">Carriage Outward</a></li>
                        <li class="breadcrumb-item" aria-current="page">Add Carriage Outward</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row align-item-center mb-4">
        <h2 class="text-muted">Generate New Carriage Outward</h2>
    </div>
    <div class="card">
        <div class="card-body">
                                    ...
                                    <div class="col">
                                        <div class="row">
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input type="text" id="seller_name" name="seller_name" class="form-control" placeholder="" readonly>
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label" for="inputEmail4">Contact Number <span class="text-danger">*</span></label>
                                                <input type="text" id="seller_contact" name="seller_contact" class="form-control" placeholder="Enter Contact Number" readonly>
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label" for="inputEmail4">Email Address<span class="text-danger">*</span></label>
                                                <input type="email" id="seller_email" name="seller_email" class="form-control" placeholder="Enter Email Address" readonly>
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label" for="inputEmail4">Pan Number<span class="text-danger">*</span></label>
                                                <input type="text" id="seller_pan" name="seller_pan" class="form-control" placeholder="Enter Pan Number" readonly>
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label" for="inputEmail4">GST Number<span class="text-danger">*</span></label>
                                                <input type="text" id="seller_gst" name="seller_gst" class="form-control" placeholder="Enter GST Number" readonly>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="inputEmail4">Address Line 1<span class="text-danger">*</span></label>
                                                <input type="text" id="seller_addone" name="seller_addone" class="form-control" placeholder="Enter Address Line 1">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="inputEmail4">Address Line 2<span class="text-danger">*</span></label>
                                                <input type="text" id="seller_addtwo" name="seller_addtwo" class="form-control" placeholder="Enter Address Line 2">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="seller_pin" name="seller_pin" placeholder="Enter Pin Code">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form action="javascript:void(0);" method="POST" name="add_customer_detail" id="add_customer_detail">
                                <div class="row">
                                    <div class="row mb-3">
                                        ...
                                        <div class="mb-3 col-md-3">
                                            <label class="form-label" for="inputEmail4">Contact Number <span class="text-danger">*</span></label>
                                            <input type="text" name="cust_contact" id="cust_phone" class="form-control" placeholder="Enter Contact Number" readonly>
                                        </div>
                                        <div class="mb-3 col-md-3">
                                            <label class="form-label" for="inputEmail4">Email Address<span class="text-danger">*</span></label>
                                            <input type="email" name="cust_email" id="cust_email" class="form-control" placeholder="Enter Email Address" readonly>
                                        </div>
                                        <div class="mb-3 col-md-3">
                                            <label class="form-label" for="inputEmail4">Pan Number<span class="text-danger">*</span></label>
                                            <input type="text" name="cust_pan" id="cust_pan" class="form-control" placeholder="Enter Pan Number" readonly>
                                        </div>
                                        <div class="mb-3 col-md-3">
                                            <label class="form-label" for="inputEmail4">GST Number<span class="text-danger">*</span></label>
                                            <input type="text" name="cust_gst" id="cust_gst" class="form-control" placeholder="Enter GST Number" readonly>
                                        </div>
                                        <div class="mb-3 col-md-3">
                                            <label class="form-label" for="inputEmail4">Order Number<span class="text-danger">*</span></label>
                                            <input type="text" name="cust_order_no" id="cust_order_no" class="form-control" placeholder="Enter Order Number">
                                        </div>
                                        <div class="mb-3 col-md-3">
                                            <label class="form-label" for="inputEmail4">Dispatch Document Number<span class="text-danger">*</span></label>
                                            <input type="text" name="cust_dispatch_no" id="cust_dispatch_no" class="form-control" placeholder="Enter Dispatch Document Number">
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="inputEmail4">Address Line 1<span class="text-danger">*</span></label>
                                                <input type="text" name="cust_addone" id="cust_bill_addone" class="form-control" placeholder="Enter Address Line 1">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label" for="inputEmail4">Address Line 2<span class="text-danger">*</span></label>
                                                <input type="text" name="cust_addtwo" id="cust_bill_addtwo" class="form-control" placeholder="Enter Address Line 2">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label" for="inputEmail4">State<span class="text-danger">*</span></label>
                            ...
                            <form action="javascript:void(0);" method="POST" name="add_other_detail" id="add_other_detail">
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" name="other_quantity" id="other_quantity" class="form-control" placeholder="Quantity of Goods">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Transport Details <span class="text-danger">*</span></label>
                                        <input type="text" name="other_transport" id="other_transport" class="form-control" placeholder="Transport Details">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Total Transport Cost <span class="text-danger">*</span></label>
                                        <input type="text" name="other_transport_cost" id="other_transport_cost" class="form-control" placeholder="Total Transport Cost">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="other_refe_no" id="other_refe_no" class="form-control" placeholder="Payment Reference No.">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Approve By</label>
                                        <input type="text" name="other_approve_by" id="other_approve_by" class="form-control" placeholder="Approve by">
                                    </div>
                                    <div class="col-md-6 mb-3">
