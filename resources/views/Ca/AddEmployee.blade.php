                                        ...
                                        <div class="col">
                                            <div class="row">
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label" for="inputEmail4">Employee Name <span
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input required type="date" name="dob" id="dob" class="form-control"
                                                        ...
                                                        onfocus="this.max = new Date(Date.now() - 86400000).toISOString().split('T')[0]">

                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label" for="inputEmail4">Gander<span
                                                            class="text-danger">*</span></label>
                                                    <div class="form-group me-2">
                                                        <select required class="select form-select" name="gender" id="gender">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label" for="inputEmail4">Aadhaar No<span
                                                            class="text-danger">*</span></label>
                                                    <input required type="text" class="form-control" name="aadhaar_number"
                                                        id="aadhaar_number" placeholder="Enter Aadhaar Number"
                                                        maxlength="12">
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label" for="inputEmail4">PAN No<span
                                                            class="text-danger">*</span></label>
                                                    <input required type="text" class="form-control" name="pan_number"
                                                        id="pan_number" placeholder="Enter PAN Number" maxlength="10">
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input required type="text" class="form-control" name="qualification"
                                                        id="qualification" placeholder="Enter highest qualification">
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label" for="pro_qualification">Professional
                                                        Qualification (if any)</label>
                                                    <input type="text" class="form-control" name="pro_qualification"
                                                        id="pro_qualification"
                                                        placeholder="Enter professional qualification">
                                                </div>

                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label" for="last_employer">Last Employer
                                                        Name</label>
                                                    <input type="text" class="form-control" name="last_employer"
                                                        id="last_employer" placeholder="Enter last employer name">
                                                </div>

                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label" for="experience_years">Year of Work
                                                        Experience</label>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input required type="text" name="c_addr_lineone" id="cust_bill_addone"
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-0">
                                                        ...
                                                        <select class="form-control select-style" name="c_emp_city"
                                                            id="city" required>
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="d-flex justify-content-between align-items-center mb-4">
                                                ...
                                                <div class="btn btn-primary" onclick="copyParamanentAddress()">Same as
                                                    Current Address</div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-0">
                                                        <label class="form-label">State<span class="text-danger">*</span></label>
                                                        <select class="form-control select-style" name="p_emp_state"
                                                            id="curr_state" required>
                                                            <option value="">Select State</option>
                                                            @foreach($states as $k=>$state)
                                                            <option value="{{ $state->id }}">{{ $state->name }}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-0">
                                                        <label class="form-label">City<span class="text-danger">*</span></label>
                                                        <select class="form-control select-style" name="p_emp_city"
                                                            id="curr_city" required>
                                                            <option value="">Select City</option>
                                                        </select>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="ref1_mobile" id="ref1_mobile"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="ref2_mobile" id="ref2_mobile"
                                                    class="form-control" placeholder="Enter mobile number"
                                                    maxlength="10"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="emergency_mobile" id="emergency_mobile"
                                                    class="form-control" placeholder="Enter mobile number"
                                                    maxlength="10"
                                                    oninput="this.value = this.value.replace(/\D/g, '');" required>
                                            </div>
                            ...
                            <div class="tab-pane" id="jobDetails">
                                <div class="">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="emp_status">Employee Status<span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select" name="emp_status" id="emp_status"
                                                    onchange="toggleStatusDate();" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="status_date"
                                                    id="status_date" placeholder="Select relevant date">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox" id="epf_check"
                                                    name="epf_applicable" value="1" onchange="toggleEPFFields()">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox" id="esic_check"
                                                    name="esic_applicable" value="1" onchange="toggleESICFields()">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox" id="ptax_check"
                                                    name="ptax_applicable" value="1">
                                                <label class="form-check-label" for="ptax_check">P-Tax
                                                    Applicable</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input" type="checkbox" id="tds_check"
                                                    name="tds_applicable" value="1">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="basic_sal">Basic Salary<span class="text-danger">*</span><span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="basic_sal" value="00.00"
                                                    id="basic_sal" placeholder="Auto-calculated based on percentage"
                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '')" readonly />
                                                <small class="form-text text-muted">Auto-calculated based on percentage
                                                    (editable)</small>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="hra" id="hra"
                                                    value="00.00" placeholder="Auto: 50% of Basic"
                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '')" readonly/>
                                                <small class="form-text text-muted">Auto-calculated as 50% of Basic
                                                    Salary (editable)</small>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="convayance"
                                                    id="convayance" value="1600.00" readonly />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="medical_allowance"
                                                    id="medical_allowance" value="1250.00" readonly />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="special_bonus"
                                                    id="special_bonus" value="00.00"
                                                    placeholder="Extra adjustable amount"
                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '')" />
                                                <small class="form-text text-muted">Adjustable extra allowance
                                                    amount</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="schoolName">Tax Deducted at Source
                                                    (TDS)</label>
                                                <input type="number" class="form-control" name="tds" id="tds" value="0"
                                                    placeholder="Enter Employee TDS " />
                                                <small class="form-text text-muted">
                                                    <i class="fas fa-info-circle"></i>
                                                    TDS shows ₹0 for salary ≤ ₹10,00,000 and auto-calculates for salary
                                                    > ₹10,00,000
                                                </small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="loan_tenure">Tenure for Repay (in
                                                    Months)</label>
                                                <input type="text" class="form-control" name="loan_tenure"
                                                    id="loan_tenure" placeholder="Enter Tenure in Months" />
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="loan_deduction">Loan Deduction
                                                    (Monthly)</label>
                                                <input type="text" class="form-control" name="loan_deduction"
                                                    id="loan_deduction" placeholder="Enter Loan Deduction Amount" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="total_deduction"
                                                    id="total_deduction" value="0.00" readonly />
                                                <small class="form-text text-muted">Auto-calculated: PF + ESI + PTAX +
                                                    TDS + Loan Deduction</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="d-flex flex-wrap justify-content-start">
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="customCheckinlh0">
                                                        <label class="form-check-label" for="customCheckinlh0">Client
                                                            Management</label>
                                                    </div>
                                                </div>
                                                <!-- Checkbox Group 1 -->
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="customCheckinlh1">
                                                        <label class="form-check-label" for="customCheckinlh1">Company
                                                            Assignment</label>
                                                    </div>
                                                </div>
                                                <!-- Checkbox Group 2 -->
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="compliances_management" name="emp_permission[]"
                                                            id="customCheckinlh2">
                                                        <label class="form-check-label"
                                                            for="customCheckinlh2">Compliances Management</label>
                                                    </div>
                                                </div>
												<div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="HR & Payroll Management" name="emp_permission[]"
                                                            id="customCheckinlh3">
                                                        <label class="form-check-label"
                                                            for="customCheckinlh3">HR & Payroll Management</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex flex-wrap justify-content-start">
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="customCheckinlh0">
                                                        <label class="form-check-label" for="customCheckinlh0">Admin
                                                            profile</label>
                                                    </div>
                                                </div>
                                                <!-- Checkbox Group 1 -->
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="customCheckinlh1">
                                                        <label class="form-check-label" for="customCheckinlh1">Manage
                                                            Subscription</label>
                                                    </div>
                                                </div>
                                                <!-- Checkbox Group 2 -->
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="customCheckinlh2">CA
                                                            Manage</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="customCheckinlh3">TDS
                                                            TAX</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="customCheckinlh4">
                                                        <label class="form-check-label" for="customCheckinlh4">Customer
                                                            Manage</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="customCheckinlh5">
                                                        <label class="form-check-label" for="customCheckinlh5">HR &
                                                            Payroll</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="customCheckinlh6">
                                                        <label class="form-check-label" for="customCheckinlh6">Business
                                                            & Earnings</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="customCheckinlh7">
                                                        <label class="form-check-label" for="customCheckinlh7">Payment
                                                            Manage</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="customCheckinlh8">
                                                        <label class="form-check-label" for="customCheckinlh8">Ticket
                                                            Manage</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="customCheckinlh9">
                                                        <label class="form-check-label" for="customCheckinlh9">Reminder
                                                            & Communication</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="customCheckinlh10">Tax
                                                            Filing & Returns</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="customCheckinlh11">Agent &
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="customCheckinlh12">Direct
                                                            Business Desk</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="customCheckinlh13">Report
                                                            Section</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="customCheckinlh14">Audit &
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label" for="customCheckinlh15">Settings
...
<script>
    ...
    function calculateAll() {
        ...
        // TDS Calculation - Auto calculate if gross salary > 10 lakh, otherwise 00.00

        if (tdsCheck.checked) {
            
            const tdsDiductAmount = 1000000; // 10 lakh as number

            if (Number(basic) > tdsDiductAmount) { // salary above limit - auto calculate
                $.ajax({
            ...
            // checkbox not checked: disable field and reset value
            tdsInput.value = "0.00";
            tdsInput.readOnly = true;
            tdsInput.disabled = true;
            tdsInput.style.backgroundColor = '#f8f9fa';
            tdsInput.title = 'Check TDS Applicable to enable this field';
        }
