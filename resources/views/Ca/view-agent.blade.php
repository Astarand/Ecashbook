            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <div class="page-header-title">
                        <h2 class="mb-0">View Agent Record</h2>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-sm-auto text-center">
                                        <div class="position-relative me-3 d-inline-flex">
                                            ...
                                            <img id="agentImagePreview"
                                                 src="{{ $agent->agent_image ? asset('storage/business_agent/' . $agent->agent_image) : asset('assets/images/application/img-prod-3.jpg') }}"
                                                 alt="agent-image"
                                    ...
                                    <div class="col">
                                        <div class="row">
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input type="text" name="agent_name" id="agent_name" value="{{ $agent->agent_name}}" class="form-control" placeholder="Email">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label" for="inputEmail4">Contact Number <span class="text-danger">*</span></label>
                                                <input type="text" name="agent_phone" id="agent_phone" value="{{ $agent->agent_phone}}" class="form-control" placeholder="Enter Contact Number">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label" for="inputEmail4">Email Address<span class="text-danger">*</span></label>
                                                <input type="email" name="agent_email" id="agent_email" value="{{ $agent->agent_email}}" class="form-control" placeholder="Enter Email Address">
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <label class="form-label" for="inputEmail4">Agent Whatsapp Number<span class="text-danger">*</span></label>
                                                <input type="number" name="agent_whats_no" id="agent_whats_no" value="{{ $agent->agent_whats_no}}" class="form-control" placeholder="Enter Agent Whatsapp Number">
                                            </div>
                                            <div class="mb-3 col-md-4">
                        ...
                        <div class=" tab-pane" id="address">                            
                           <!-- <form action="javascript:void(0);" method="post" name="addAgentaddressFrm" id="addAgentaddressFrm" enctype="multipart/form-data">-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mb-0">
                                                    ...
                                                    <select class="form-control" name="agent_state" id="agent_state" onChange="changeState(this);">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mb-0">
                                                    ...
                                                    <input type="text" name="agent_pincode" id="agent_pincode" value="{{ $agent->agent_pincode}}" class="form-control" placeholder="Enter Zip Code">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="first">
                                    ...
                                    <div class="last">
                                        <a href="{{ route('ca.AgentList') }}" class="btn btn-danger d-flex align-items-center justify-content-center">
