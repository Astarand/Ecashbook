                        ...
                        <div class="tab-content">
                                        ...
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input type="text" name="phone" id="phone" required value="{{ $employee->phone }}" class="form-control" placeholder="Enter Contact Number">
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label" for="email">Email Address<span class="text-danger">*</span></label>
                                                    <input type="email" name="email" id="email" required value="{{ $employee->email_id }}" class="form-control" placeholder="Enter Email Address">
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label" for="dob">Date of Birth<span class="text-danger">*</span></label>
                                                    <input type="date" name="dob" id="dob" required value="{{ $employee->dob }}" class="form-control">
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label" for="gender">Gender<span class="text-danger">*</span></label>
                                                    <div class="form-group me-2">
                                                        <select class="select form-select" name="gender" required id="gender">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="qualification" required id="qualification" value="{{ $employee->qualification }}" placeholder="Enter highest qualification">
                                                </div>
                                            </div>
                                ...
                                <div class="">
                                    <div class="row">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-group me-2" style="flex-grow: 1;">
                                                    ...
                                                    <select class="select form-select" required name="dept_id" id="dept_id" onchange="getDesignationsByDept(this.value);">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-group me-2" style="flex-grow: 1;">
                                                    <select class="select form-select" name="designation_id" required id="designation_id">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" required name="emp_joining_date" id="emp_joining_date" placeholder="Enter Employee Joining date"  value="{{ $employee->joining_date ?? '' }}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="total_addition" id="total_addition" value="{{ $employee->total_addition ?? '' }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="basic_sal">Basic Salary <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" required readonly name="basic_sal" id="basic_sal" placeholder="Enter Employee Basic Salary" value="{{ $employee->basic_sal ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="hra">HRA <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" required readonly name="hra" id="hra"  value="{{ $employee->hra ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="convayance">Convayance <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="provident_fund">Provident Fund <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="provident_fund" id="provident_fund" readonly value="{{ $employee->provident_fund ?? '0' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="esi">ESI <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="esi" id="esi" placeholder="Enter ESI" readonly value="{{ $employee->esi ?? '0' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="ptax">Professional Tax <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="ptax" id="ptax" readonly placeholder="Enter Professional Tax" value="{{ $employee->ptax ?? '0' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="tds">TDS / IT <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="tds" id="tds" placeholder="Enter TDS / IT" value="{{ $employee->tds ?? '0' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="total_deduction">Total Deduction <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="total_deduction" readonly id="total_deduction" placeholder="Enter Total Deduction" value="{{ $employee->total_deduction ?? '0' }}">
                                            </div>
                                        </div>
                                        ...
                                        {{-- <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="total_addition">Total Addition <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="total_addition" readonly id="total_addition" placeholder="Enter Total Addition" value="{{ $employee->total_addition ?? '0' }}">
                                            </div>
                                        </div> --}}
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="net_sal">Net Salary <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="net_sal" id="net_sal" readonly placeholder="Enter Net Salary" value="{{ $employee->net_sal ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="net_sal_word">Net Salary in Words <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="net_sal_word" readonly id="net_sal_word" placeholder="Enter Net Salary in Words" value="{{ $employee->net_sal_word ?? '' }}">
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane" id="access">
                                            ...
                                            <div class="d-flex flex-wrap justify-content-start">
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="payroll_management_ca" name="emp_permission[]" id="customCheckinlh0">
                                                        <label class="form-check-label" for="customCheckinlh0">Payroll Management</label>
                                                    </div>
                                                </div>
                                                <!-- Checkbox Group 1 -->
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="company_assignment" name="emp_permission[]" id="customCheckinlh1">
                                                        <label class="form-check-label" for="customCheckinlh1">Company Assignment</label>
                                                    </div>
                                                </div>
                                                <!-- Checkbox Group 2 -->
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="company_list" name="emp_permission[]" id="customCheckinlh2">
                                                        <label class="form-check-label" for="customCheckinlh2">Company List</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="business_agent" name="emp_permission[]" id="customCheckinlh3">
                                                        <label class="form-check-label" for="customCheckinlh3">Business Agent</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="task_management" name="emp_permission[]" id="customCheckinlh4">
                                                        <label class="form-check-label" for="customCheckinlh4">Task Management</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="reminder_company" name="emp_permission[]" id="customCheckinlh5">
                                                        <label class="form-check-label" for="customCheckinlh5">Reminder to Company</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="compliances_status" name="emp_permission[]" id="customCheckinlh6">
                                                        <label class="form-check-label" for="customCheckinlh6">Compliances Status</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="earning_management" name="emp_permission[]" id="customCheckinlh7">
                                                        <label class="form-check-label" for="customCheckinlh7">Earning Management</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="payment" name="emp_permission[]" id="customCheckinlh8">
                                                        <label class="form-check-label" for="customCheckinlh8">Payment</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card shadow-sm border-0 p-3 m-2" style="width: 18%;">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="custom_invoice_ca" name="emp_permission[]" id="customCheckinlh9">
                                                        <label class="form-check-label" for="customCheckinlh9">Custom Invoice</label>
                                                    </div>
                                                </div>
                                ...
                                <div class="d-flex wizard justify-content-between mt-3">
                                    ...
                                    <div class="last">
                                        <a href="{{ route('CA.EmployeeList') }}" class="btn btn-danger align-items-center justify-content-center">
                                            <i class="ti ti-arrow-up-circle me-2"></i> Cancel
                                        </a>
                                    </div>
                                </div>
                                <!-- end row -->
