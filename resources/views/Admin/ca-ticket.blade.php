                    ...
                    <table class="table tbl-product m-0" id="pc-dt-simple">
                        ...
                        <tbody>
                            ...
                            <!--<tr>
                                ...
                                <td><span class="fw-medium">#TKT-1023</span></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <h6 class="mb-0">Cannot update profile information</h6>
                                            <small class="text-muted d-block">Form submission error</small>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            ...
                                            <a class="text-muted f-12" href="mailto:emma@example.com">emma@example.com</a>
                                        </div>
                                    </div>
                                </td>
                                <td>2023-06-14 11:20 AM</td>
                                <td>2023-06-14 11:20 AM</td>
                                <td><span class="badge bg-warning">Medium</span></td>
                                <td><span class="badge bg-primary">New</span></td>
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('admin.ticket-view') }}" class="btn btn-sm btn-icon btn-outline-primary" data-bs-toggle="tooltip" title="View Ticket">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><span class="fw-medium">#TKT-1022</span></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <h6 class="mb-0">How to download invoice for past orders</h6>
                                            <small class="text-muted d-block">Invoice retrieval question</small>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            ...
                                            <a class="text-muted f-12" href="mailto:robert@example.com">robert@example.com</a>
                                        </div>
                                    </div>
                                </td>
                                <td>2023-06-12 03:15 PM</td>
                                <td>2023-06-13 10:30 AM</td>
                            ...
                            <tr>
                                ...
                                <td><span class="fw-medium">#TKT-1021</span></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <h6 class="mb-0">Website down - 503 Service Unavailable</h6>
                                            <small class="text-muted d-block">Critical system error</small>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <h6 class="mb-0">Mike Peterson</h6>
                                            <a class="text-muted f-12" href="mailto:mike@example.com">mike@example.com</a>
                                        </div>
                                    </div>
                                </td>
                                <td>2023-06-10 07:45 AM</td>
                                <td>2023-06-10 11:52 AM</td>
                            ...
                            <tr>
                                ...
                                <td><span class="fw-medium">#TKT-1020</span></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <h6 class="mb-0">Request for refund on order #45678</h6>
                                            <small class="text-muted d-block">Product damaged during delivery</small>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div>
                                            ...
                                            <a class="text-muted f-12" href="mailto:sarah@example.com">sarah@example.com</a>
                                        </div>
                                    </div>
                                </td>
                                <td>2023-06-09 02:18 PM</td>
                                <td>2023-06-14 09:05 AM</td>
                                <td><span class="badge bg-warning">Medium</span></td>
