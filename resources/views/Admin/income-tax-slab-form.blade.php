            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">{{ isset($slab) ? 'Edit' : 'Create' }} Income Tax Slab</li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <div class="page-header-title">
                        <h2 class="mb-0">{{ isset($slab) ? 'Edit' : 'Create' }} Income Tax Slab</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ isset($slab) ? 'Edit' : 'Add New' }} Income Tax Slab Master</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" id="submitBtn" class="btn btn-primary">
                                    <i class="ti ti-device-floppy"></i> {{ isset($slab) ? 'Update' : 'Create' }} Income Tax Slab
                                </button>
