        ...
        <div class="page-block">
            <div class="row align-items-center">
                ...
                <div class="col-md-8 text-end">
                    <a href="{{ route('admin.AdminAddEmployee') }}" class="btn btn-primary"><i class="ti ti-square-plus"></i> Add New Employee</a>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="prod-action-links">
                                        <ul class="list-inline me-auto mb-0">
                                            ...
                                            <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="View">
                                                <a href="{{ url('view_admin_employee/' . $encodedId) }}" class="avtar avtar-xs btn-link-success btn-pc-default">
                                                    <i class="ti ti-eye f-18"></i>
                                                </a>
                                            </li>
                                            <!-- Edit Employee -->
                                            <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Edit">
                                                <a href="{{ url('edit_admin_employee/' . $encodedId) }}" class="avtar avtar-xs btn-link-warning btn-pc-default">
