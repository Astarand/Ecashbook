				...
				<ul class="pc-navbar">
					...
					@if (in_array('ALL', $userMenu) || in_array('Accounting', $userMenu))
						<li class="pc-item pc-hasmenu">
							<a href="#!" class="pc-link"><span class="pc-micon"><i class="ph-duotone ph-arrows-down-up"></i> </span><span class="pc-mtext">Accounting &
									Finance </span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
							<ul class="pc-submenu">
								<li class="pc-item pc-hasmenu">
									<a href="#!" class="pc-link"><span>Business Operations</span> <span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
									<ul class="pc-submenu">
								...
								<li class="pc-item pc-hasmenu">
									<a href="#!" class="pc-link"><span>Sales & Revenue</span> <span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
									<ul class="pc-submenu">
								...
								<li class="pc-item pc-hasmenu">
									<a href="#!" class="pc-link"><span>Purchase & Procurement</span> <span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
									<ul class="pc-submenu">
								...
								<li class="pc-item"><a class="pc-link" href="{{ route('user.OtherIncomeList') }}">Other Income</a></li>
								<li class="pc-item"><a class="pc-link" href="{{ route('user.ExpensesList') }}">Expense Management</a></li>
					...
					@if (in_array('ALL', $userMenu) || in_array('Assets & Liabilities', $userMenu))
						<li class="pc-item pc-hasmenu">
							<a href="#!" class="pc-link"><span class="pc-micon"><i class="ph-duotone ph-buildings"></i></span><span class="pc-mtext">Assets &
									Liabilities</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
							<ul class="pc-submenu">
								<li class="pc-item pc-hasmenu">
									<a href="#!" class="pc-link"><span>Asset Management</span> <span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
									<ul class="pc-submenu">
					...
					@if(in_array('ALL', $userMenu) || in_array('Cash & Banking', $userMenu))
						<li class="pc-item pc-hasmenu">
							<a href="#!" class="pc-link"><span class="pc-micon"><i class="ph-duotone ph-wallet"></i></span><span class="pc-mtext">Cash
					...
					@if(in_array('ALL', $userMenu) || in_array('Financial Reports', $userMenu))
						<li class="pc-item pc-hasmenu">
							...
							<ul class="pc-submenu">
								...
								<li class="pc-item"><a class="pc-link" href="{{ route('user.TrialBalanceReport') }}">Trial
										Balance (TB)</a></li>
								<li class="pc-item"><a class="pc-link" href="{{ route('user.ProfitLossReport') }}">Profit &
										Loss Statement</a></li>
								<li class="pc-item"><a class="pc-link" href="{{ route('user.BalanceSheetReport') }}">Balance Sheet</a></li>
					...
					@if(in_array('ALL', $userMenu) || in_array('Inventory Management', $userMenu))
						<li class="pc-item pc-hasmenu">
							<a href="#!" class="pc-link"><span class="pc-micon"><i class="ph-duotone ph-lockers"></i></span><span class="pc-mtext">Inventory
							...
							<ul class="pc-submenu">
								<li class="pc-item"><a class="pc-link" href="{{ route('user.Inventory') }}">Inventory
										Management</a></li>
								<li class="pc-item"><a class="pc-link" href="{{ route('user.expenses_inventory') }}">Inventory Expenses</a></li>
							</ul>
						</li>
					@endif
					...
					@if(in_array('ALL', $userMenu) || in_array('Tax Filing & Returns', $userMenu))
						<li class="pc-item pc-hasmenu">
							...
							<ul class="pc-submenu">
								<li class="pc-item pc-hasmenu">
									<a href="#!" class="pc-link"><span>GST Management & Returns</span> <span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
									<ul class="pc-submenu">
...
<ul class="pc-submenu">
	<li class="pc-item"><a class="pc-link" href="{{ route ('user.tds_returns_filing') }}">TDS Returns & Filing</a></li>
								...
								<li class="pc-item"><a class="pc-link" href="{{ route('user.pf_management_list') }}">Provident Fund (PF/EPF)</a></li>
								<li class="pc-item"><a class="pc-link" href="{{ route('user.esi_management_list') }}">Employees' State Insurance
										(ESI)</a>
								</li>
						...
						<li class="pc-item pc-hasmenu">
							...
							<ul class="pc-submenu">
								<li class="pc-item pc-hasmenu">
									...
									<ul class="pc-submenu">
										<li class="pc-item"><a class="pc-link" href="{{ route('user.EmployeeList') }}">Employee Master </a></li>
										<li class="pc-item"><a class="pc-link" href="{{ route('user.AttendanceList') }}">Attendence History</a></li>
										...
										<li class="pc-item"><a class="pc-link" href="{{ route('user.HRLetterList') }}">HR
												Letter & Docs</a></li>
								...
								<li class="pc-item"><a class="pc-link" href="{{ route('user.ExpenditureClaims') }}">Expense
										Reimbursements</a></li>
				...
				@if(in_array('ALL', $userMenu) || in_array('Professional Services', $userMenu))
					<li class="pc-item pc-hasmenu">
						<a href="#!" class="pc-link"><span class="pc-micon"><i class="ph-duotone ph-detective"></i></span><span class="pc-mtext">Compliance advisory</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
						<ul class="pc-submenu">
				...
				@if(in_array('ALL', $userMenu) || in_array('Technology Services', $userMenu))
					<li class="pc-item pc-hasmenu">
						<a href="#!" class="pc-link"><span class="pc-micon"><i class="ph-duotone ph-wrench"></i></span><span class="pc-mtext">Digital Business Solutions</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
						<ul class="pc-submenu">
	...
	<li class="pc-item"><a class="pc-link" href="{{ route('CA.GeneratePayslip') }}">Generate Payslip</a></li>
		...
		@if (Auth::user()->u_type == 3 || Auth::user()->u_type == 6)
			<ul class="pc-navbar">
				...
				{{-- HR & Payroll Management  khokan payroll --}}
...
<ul class="pc-submenu">
	<li class="pc-item"><a class="pc-link" href="{{ route ('user.tds_returns_filing') }}">TDS Returns & Filing</a></li>
			...
			@if(canAccess('Professional Services', $userMenu, $permissions))
				<li class="pc-item pc-hasmenu">
					<a href="#!" class="pc-link"><span class="pc-micon"><i class="ph-duotone ph-detective"></i></span><span class="pc-mtext">Professional
			...
			@if(canAccess('Technology Services', $userMenu, $permissions))
				<li class="pc-item pc-hasmenu">
					<a href="#!" class="pc-link"><span class="pc-micon"><i class="ph-duotone ph-wrench"></i></span><span class="pc-mtext">Technology
							Services</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
					<ul class="pc-submenu">
						{{-- <li class="pc-item"><a class="pc-link" href="{{ route('company-branding') }}" target="_blank">Company Branding</a></li> --}}
						<li class="pc-item"><a class="pc-link" href="{{ route('web-and-app') }}" target="_blank">Website & App Development</a></li>
