						...
						<ul class="pc-submenu">
							...
							<li class="pc-item pc-hasmenu">
								...
								<ul class="pc-submenu">
									...
									<li class="pc-item"><a class="pc-link" href="#">Shops Registration</a></li>
									<li class="pc-item"><a class="pc-link" href="#">Wage Compliance</a></li>
									<li class="pc-item"><a class="pc-link" href="#">Employee Welfare</a></li>
								</ul>
							</li>
							@endif
				...
				<ul class="pc-navbar">
					...
					@if($msmeMenu && canAccess('MSME Benefits Hub', $userMenu, $permissions))
						<li class="pc-item pc-hasmenu">
							...
							<ul class="pc-submenu">
								<li class="pc-item"><a class="pc-link" href="#"><i class="ph-duotone ph-compass me-2"></i>Discover Schemes</a></li>
								<li class="pc-item"><a class="pc-link" href="#"><i class="ph-duotone ph-check-circle me-2"></i>Eligibility Checker</a></li>
								<li class="pc-item"><a class="pc-link" href="#"><i class="ph-duotone ph-bank me-2"></i>Loan & Subsidy</a></li>
								<li class="pc-item"><a class="pc-link" href="#"><i class="ph-duotone ph-rocket-launch me-2"></i>Startup Benefits</a></li>
								<li class="pc-item"><a class="pc-link" href="#"><i class="ph-duotone ph-newspaper me-2"></i>Govt Updates</a></li>
								<li class="pc-item"><a class="pc-link" href="#"><i class="ph-duotone ph-users-three me-2"></i>Consultant Assistance</a></li>
							</ul>
						</li>
					@endif
