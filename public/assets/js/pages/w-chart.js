    ...
    (function () {
        ...
        var options_yearly_summary = {
            ...
            series: [
                ...
                {
                    name: "Expenses", // Changed from "Revenue"
                    data: [44, 55, 57, 56, 61],
                },
            ],
            xaxis: {
            ...
            yaxis: {
                labels: {
                    formatter: function (val) {
                        return val * 5 + "k"; // Custom y-axis scaling
                    },
                },
            },
            tooltip: {
                y: {
                    formatter: function (val) {
                        return "$ " + val + "k"; // Tooltip formatting
                    },
                },
            },
        };

        var chart_yearly_summary = new ApexCharts(
            document.querySelector("#yearly-summary-chart"),
            options_yearly_summary
        );
        ...
        var chart_summary = new ApexCharts(
            document.querySelector("#company-assignment-chart"),
            options_summary
        );
        chart_summary.render();
        ...
        var chart_monthly_report = new ApexCharts(
            document.querySelector("#in-ex-report-graph"),
            options_monthly_report
        );
        ...
        var chart_overview_bar = new ApexCharts(
        ...
        var chart_overview_2 = new ApexCharts(
        ...
        var chart_performance = new ApexCharts(
        ...
        var chart_project_rating = new ApexCharts(
            document.querySelector("#project-rating-chart"),
        ...
        var chart_transactions = new ApexCharts(
        ...
        var chart_canceled_order = new ApexCharts(
            document.querySelector("#canceled-order-chart"),
        ...
        var options_total_order = {
            ...
            series: [
                {
                    data: [
                        30, 60, 40, 70, 50, 90, 50, 55, 45, 60, 50, 65, 30, 60,
                        40, 70, 50, 90, 50, 55, 45, 60, 50, 65, 40, 70, 50, 90,
                        50,
                    ],
                },
            ],
        };
        var chart_total_order = new ApexCharts(
        ...
        var chart_rewards = new ApexCharts(
            document.querySelector("#total-rewards-chart"),
            options_rewards
        );
        ...
        var chart_total_earning = new ApexCharts(
            document.querySelector("#total-earning-chart-1"),
        ...
        var chart_total_earning_2 = new ApexCharts(
            document.querySelector("#total-earning-chart-2"),
        ...
        var chart_bitcoin_1 = new ApexCharts(
            document.querySelector("#bitcoin-chart-1"),
            options_bitcoin_1
        );
        ...
        var chart_bitcoin_2 = new ApexCharts(
            document.querySelector("#bitcoin-chart-2"),
            options_bitcoin_2
        );
        ...
        var chart_bitcoin_3 = new ApexCharts(
            document.querySelector("#bitcoin-chart-3"),
            options_bitcoin_3
        );
        ...
        var chart_total_rewards = new ApexCharts(
            document.querySelector("#total-rewards-chart-2"),
        ...
        var chart_time_spent = new ApexCharts(
        ...
        var chart_new_visitor = new ApexCharts(
        ...
        var chart_reports = new ApexCharts(
