...
class TdsPfEsiController extends Controller
{
	...
	{
		return view('User.shop-registration');
	}

	public function lwf_compliance(Request $request)
	{
		return view('User.lwf-compliance');
	}

	public function gratuity_compliance(Request $request)
	{
		return view('User.gratuity-compliance');
	}
